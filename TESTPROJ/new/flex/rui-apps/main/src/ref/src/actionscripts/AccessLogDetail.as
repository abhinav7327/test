...
// ActionScript file
 ...
 // ActionScript file for Access Log Detail
    ...
    public function parseUrlString():void {
        try {
            ...
            for (var i:int = 0; i < params.length; i++) {
                ...
                if (tempA[0] == "employeePk") {
                    o.employeePk = tempA[1];
                    employeePk = o.employeePk;
                }    
            } 
   ...
   private function populateRequestParams():Object {
        ...
        var reqObj : Object = new Object();
         reqObj.employeePk = employeePk;
         reqObj.actionType = "view";
         return reqObj;
    }
    
    private function showEmployeeHistoryInfo():void{
			
			var sPopup : SummaryPopup;
            var parentApp :UIComponent = UIComponent(this.parentApplication);
            sPopup= SummaryPopup(PopUpManager.createPopUp(parentApp,SummaryPopup,true));
            sPopup.title = "Employee Close/Reopen History";
            sPopup.width = 780;
            sPopup.height = 400;
            PopUpManager.centerPopUp(sPopup);

           sPopup.moduleUrl = Globals.EMPLOYEE_HISTORY;
