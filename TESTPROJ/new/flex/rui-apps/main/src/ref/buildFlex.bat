...
rem echo start building resource file for REF 
mxmlc -locale=en_US -source-path=%CURRENT_DIR%\..\..\locale/{locale} -include-resource-bundles=collections,containers,controls,core,effects,refResources,skins,styles -output=%CURRENT_DIR%\..\..\target\assets\appl\%MODULE%\refResources_en_US.swf
rem echo end building resource file for REF 
rem FOR %%f IN (%COMPL_DIR%\*.MXML) DO mxmlc -locale=en_US -source-path=%CURRENT_DIR%\..\..\locale/{locale} -include-resource-bundles=collections,core,effects,coreResources,refResources,skins,styles -load-config=%CURRENT_DIR%\..\..\..\..\..\assembly\src\web\flex\flex-config.xml -runtime-shared-library-path=%CURRENT_DIR%\..\..\..\..\..\assembly\src\web\flex\libs\framework.swc,rsls/framework_3.0.0.477.swf -runtime-shared-library-path=%CURRENT_DIR%\..\..\..\..\..\assembly\src\web\flex\libs\rpc.swc,rsls/rpc_3.0.0.477.swf -runtime-shared-library-path=%CURRENT_DIR%\..\..\..\..\..\assembly\src\web\flex\libs\datavisualization.swc,rsls/datavisualization_3.0.0.477.swf -runtime-shared-library-path=%CURRENT_DIR%\..\..\target\local-libs\core-4.10.120.0.0.swc,rsls/core-4.10.120.0.0.swf -runtime-shared-library-path=%CURRENT_DIR%\..\..\target\local-libs\ref-4.10.120.0.0.swc,rsls/ref-4.10.120.0.0.swf %%f
"%JAVA_HOME%\bin\java" -Xmx1024m -jar "%FLEX_HOME%\lib\compiler.jar" %CURRENT_DIR%/../../target/local-libs/core-4.10.120.0.0.swc,rsls/core-4.10.120.0.0.swf %CURRENT_DIR%/../../target/local-libs/ref-4.10.120.0.0.swc,rsls/ref-4.10.120.0.0.swf
