...
import com.nri.rui.trd.validator.TradeTxnQueryValidator;
  ...
  /**
    ...
    */
    ...
    override public function preQueryInit():void{
        ...
        super.getInitHttpService().url = "trd/tradeTxnDetailQueryDispatch.action?method=initialExecute&&menuType=Y&rnd=" + rndNo;         
    }
    ...
    override public function preQuery():void{
        ...
        super.getSubmitQueryHttpService().url = "trd/tradeTxnDetailQueryDispatch.action?";  
    ...
    override public function preResetQuery():void{
        var rndNo:Number= Math.random();
        super.getResetHttpService().url = "trd/tradeTxnDetailQueryDispatch.action?method=resetQuery&&menuType=Y&rnd=" + rndNo;            
    }
        
    override    public function preGenerateXls():String{
        var url : String =null;
            url = "trd/tradeTxnDetailQueryDispatch.action?method=generateXLS";
            return url;
    }  
    override public function preGeneratePdf():String{
        //XenosAlert.info("preGeneratePdf");
        var url : String =null;  
            url = "trd/tradeTxnDetailQueryDispatch.action?method=generatePDF";
            return url;
    } 
    ...
    public function submitQuery():void {
	    if(XenosStringUtils.isBlank(this.fundPopUp.fundCode.text)){
			XenosAlert.error(this.parentApplication.xResourceManager.getKeyValue('trd.tradetxndetailquery.error.fundcode'));
		}else{
    ...
    private function setValidator():void{
	    ...
	    var tradeTxnQueryModel:Object={
                        tradeTxnQuery:{                                 
                             fundCode:this.fundPopUp.fundCode.text
                        }
                       }; 
         super._validator = new TradeTxnQueryValidator();
         super._validator.source = tradeTxnQueryModel ;
         super._validator.property = "tradeTxnQuery";
		}
