 ...
 // ActionScript file for Trade Cnf Read Only Query
    ...
    */
    private function initPageStart():void {   
        ...
        if (!initCompFlg) {    
            ...
            req.SCREEN_KEY = 12029;
            initializeTradeQuery.request = req;        
            initializeTradeQuery.url = "trd/tradeMatchingReadOnlyQueryDispatch.action?method=initialExecute&&menuType=Y&rnd=" + rndNo;                    
    ...
    */
     private function generateXls():void {
    	var url : String = "trd/tradeMatchingReadOnlyQueryDispatch.action?method=generateXLS";
    ...
    */
     private function generatePdf():void {
    	var url : String = "trd/tradeMatchingReadOnlyQueryDispatch.action?method=generatePDF";
    	var request:URLRequest = new URLRequest(url);
    	request.method = URLRequestMethod.POST;
