...
// ActionScript file
 ...
 // ActionScript file for Trade Cnf Query
    ...
    [Bindable]private var mode : String = Globals.MODE_ALLOC_CXL;
    ...
    */
    private function initPageStart():void {   
        ...
        if (!initCompFlg) {    
            ...
            initializeTradeQuery.url = "trd/tradeAllocCxlQueryDispatch.action?method=initialExecute&&menuType=Y&rnd=" + rndNo;                    
    ...
    */
     private function generateXls():void {
    	var url : String = "trd/tradeAllocCxlQueryDispatch.action?method=generateXLS";
    ...
    */
     private function generatePdf():void {
    	var url : String = "trd/tradeAllocCxlQueryDispatch.action?method=generatePDF";
    	var request:URLRequest = new URLRequest(url);
    	request.method = URLRequestMethod.POST;
...
// This as file contains code specific to the Check Box Selections.    
    ...
    public function checkSelectToModify(item:Object):void {
     ...
     private function loadUnmatchUserConfirmation(selIndArr:Array):void {
		...
		sPopup.moduleUrl = "assets/appl/trd/TradeUnmatchPopup.swf?selIndexArr="+selIndArr+"&mode="+mode;
     }
     ...
     public function loadMatchOueryPage(selIndexArray:Array):void {
				...
				if(allocConfFlag=="A"){
					...
					sPopup.moduleUrl = "assets/appl/trd/TradeCnfMatchPopup.swf?selIndexArr="+selIndexArray
										+"&parentAllocConfFlag="+allocConfFlag+"&mode="+mode;;
	...
	public function closePopUp(event:CloseEvent):void{
     ...
     public function LoadRejectOueryPage():void {
	    		...
	    		sPopup.owner=this;
				PopUpManager.centerPopUp(sPopup);
				sPopup.moduleUrl = "assets/appl/trd/TradeRejectionPopup.swf?ReceivedConfirmationPk="+rcvCnfPk
									+"&ConfirmationTradePk="+confirmationTradePk
									+"&fundAccNo="+fundAccNoStr+"&mode="+mode;;
     }
