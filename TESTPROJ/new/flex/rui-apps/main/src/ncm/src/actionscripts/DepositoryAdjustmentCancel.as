    ...
    */
     private function initPageStart():void {            
        if (!initCompFlg) {
            ...
            initDepositoryAdjustmentQuery.url = "ncm/depositoryCancelQueryDispatchAction.action?method=initialExecute&opMode=DELETE&rnd=" + rndNo;                    
  ...
  /**
    ...
    */
    private function populateRequestParams():Object {
        ...
        reqObj.modeOfOperation = Globals.MODE_DELETE;
    ...
    */
     private function generateXls():void {
        var url : String = "ncm/depositoryCancelQueryDispatchAction.action?method=generateXLS";
    ...
    */
     private function generatePdf():void {
        var url : String = "ncm/depositoryCancelQueryDispatchAction.action?method=generatePDF";
        var request:URLRequest = new URLRequest(url);
        request.method = URLRequestMethod.POST;
        // set menu pk in the request
      	var variables:URLVariables = new URLVariables();
