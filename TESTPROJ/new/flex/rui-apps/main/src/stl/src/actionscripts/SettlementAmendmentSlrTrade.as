...
private function addCommonResultKes():Object{
	...
	keylist.addItem("securityStlDetail.description"); //19
	...
	keylist.addItem("cashStlDetail.cpExtSettleAccountName4");//28	
	keylist.addItem("cashStlDetail.description"); //29
	
	/* Extra for hidden field population */
	keylist.addItem("isSuppressed"); //30
	...
	keylist.addItem("diffCashFlag");//35
	...
	keylist.addItem('securityStlDetail.cpBankCodeType');//45
	...
	keylist.addItem("securityStlDetail.participantId2"); 
...
override public function postAmendResultInit(mapObj:Object): void {
	...
	if(mapObj!=null) {
		...
		if(errorArrCol.length>0) {
			...
			this.parentDocument.title = this.parentApplication.xResourceManager.getKeyValue('stl.amendment.title.slrtrade');
...
private function commonAmendResult(mapObj:Object):void{
    ...
    mapCashSdVOColl = mapObj[keylist.getItemAt(20)] as ArrayCollection;
    ...
    this.brokerBic.text = mapObj["securityStlDetail.brokerBic"].toString();
    this.participantId.text = mapObj["securityStlDetail.participantId"].toString();
    this.participantId2.text = mapObj["securityStlDetail.participantId2"].toString();
    ...
    this.ourSettleAc.text = getVoAttbValue(mapSecSdVOColl,"ourSettleAc");
    this.description.text = mapObj[keylist.getItemAt(19)].toString();
    ...
    index=-1;
    for each(item in (mapObj[keylist.getItemAt(22)] as ArrayCollection)){
        initcol.addItem(item);
                
        if(item.value == mapObj[keylist.getItemAt(21)].toString()){
            index = (mapObj[keylist.getItemAt(22)] as ArrayCollection).getItemIndex(item);        
        }
    }
    ...
    this.cashCpSettleAcName1stLine.text = mapObj[keylist.getItemAt(25)].toString();
    this.cashCpSettleAcName2ndLine.text = mapObj[keylist.getItemAt(26)].toString();
    this.cashCpSettleAcName3rdLine.text = mapObj[keylist.getItemAt(27)].toString();
    this.cashCpSettleAcName4thLine.text = mapObj[keylist.getItemAt(28)].toString();
    ...
    this.cashDescription.text = mapObj[keylist.getItemAt(29)].toString();
...
private function populateHiddenFields(mapObj:Object):void{
    isSuppressed = mapObj[keylist.getItemAt(30)].toString();
    nonSuppressedSide = mapObj[keylist.getItemAt(31)].toString();
    isBrokerAccount = mapObj[keylist.getItemAt(32)].toString();
    cashSSILayout = mapObj[keylist.getItemAt(33)].toString();
    secSSILayout = mapObj[keylist.getItemAt(34)].toString();
    diffCashFlag = mapObj[keylist.getItemAt(35)].toString();
    cashSIVOSettlementInfoStatus = mapObj[keylist.getItemAt(36)].toString();
    siVOSettlementInfoStatus = mapObj[keylist.getItemAt(6)].toString();
    csiVoSettlementFor = mapObj[keylist.getItemAt(37)].toString();
    secSDetailDeliveryMethod = mapObj[keylist.getItemAt(10)].toString();
    siVoInventoryAccountPk = mapObj[keylist.getItemAt(38)].toString();
    cashSiVoInventoryAccountPk = mapObj[keylist.getItemAt(39)].toString();
    secCpChainIndex = mapObj[keylist.getItemAt(40)].toString();
    secOurChainIndex = mapObj[keylist.getItemAt(41)].toString();
    cashCpChainIndex = mapObj[keylist.getItemAt(42)].toString();
    cashOurChainIndex = mapObj[keylist.getItemAt(43)].toString();
    secSDFurtherCredit = mapObj[keylist.getItemAt(44)].toString();
    cpBankCodeType = mapObj[keylist.getItemAt(45)].toString();
    cashFurtherCredit = mapObj[keylist.getItemAt(46)].toString();
    cashCpBankCodeType = mapObj[keylist.getItemAt(47)].toString();
...
{        
    ...
    if(!errPage.isError()){
        this.parentDocument.title = this.parentApplication.xResourceManager.getKeyValue('stl.amendment.title.slrtrade')+" - "+ this.parentApplication.xResourceManager.getKeyValue('stl.message.userconfirmation');
...
override public function postConfirmAmendResultHandler(mapObj:Object):void
{
    ...
    if(mapObj != null && mapObj["errorFlag"].toString() != "error"){
        this.parentDocument.title =this.parentApplication.xResourceManager.getKeyValue('stl.amendment.title.slrtrade')+" - "+ this.parentApplication.xResourceManager.getKeyValue('stl.message.sysconfirmation');        
    }
}
override public function postCancelResultHandler(mapObj:Object): void{
    commonResult(mapObj);    
    if(!errPage.isError())
        this.parentDocument.title =this.parentApplication.xResourceManager.getKeyValue('stl.amendment.view.title.slrtrade');
...
private function commonResultPart(mapObj:Object):void{
    ...
    this.uDescription.text = mapObj[keylist.getItemAt(19)].toString();
    ...
    this.uWayofpayment.text = mapObj[keylist.getItemAt(21)].toString();
    this.uPaymentReceive.text = getVoAttbValue(mapCashSdVOColl,"deliverReceive");
    this.uCashSettlementmode.text = mapObj[keylist.getItemAt(23)].toString();
    this.uInxForNormal.text = mapObj[keylist.getItemAt(24)].toString();
    ...
    this.uCashCpSettleAcName1stLine.text = mapObj[keylist.getItemAt(25)].toString();
    this.uCashCpSettleAcName2ndLine.text = mapObj[keylist.getItemAt(26)].toString();
    this.uCashCpSettleAcName3rdLine.text = mapObj[keylist.getItemAt(27)].toString();
    this.uCashCpSettleAcName4thLine.text = mapObj[keylist.getItemAt(28)].toString();
    ...
    this.uCashDescription.text = mapObj[keylist.getItemAt(29)].toString();
    
    this.viewType = mapObj[keylist.getItemAt(48)].toString();
    this.uPlaceofsettlement.text = getVoAttbValue(mapSecSdVOColl,"placeOfSettlement");
    this.uBrokerBic.text = mapObj["securityStlDetail.brokerBic"].toString();
    this.uParticipantId.text = mapObj["securityStlDetail.participantId"].toString();
    this.uParticipantId2.text = mapObj["securityStlDetail.participantId2"].toString();
