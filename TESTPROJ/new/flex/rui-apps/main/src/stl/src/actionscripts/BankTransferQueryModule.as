...
import com.nri.rui.stl.validators.BankTransferQueryValidator;
...
import mx.events.DataGridEvent;
    ...
    override public function preQueryInit():void {
	    ...
	    reqObject.SCREEN_KEY = 739;
        super.getInitHttpService().request = reqObject;
	  	super.getInitHttpService().url = "stl/bankTransferCancelDispatch.action?method=initialExecute&mode=query&menuType=Y&rnd=" + rndNo;        	
    }
    ...
    override public function preCancelInit():void {
	   var rndNo:Number= Math.random();
	   super.getInitHttpService().url = "stl/bankTransferCancelDispatch.action?&rnd=" + rndNo;  
	    var reqObject:Object = new Object();
    ...
    private function commonInit(mapObj:Object):void{
        ...
        var sortField2Default:String = "our_bank_settle_acc";
        var sortField3Default:String = "value_date";
        ...
        for each(var itemSort:Object in (mapObj[keylist.getItemAt(1)] as ArrayCollection)) {
    ...
    private function populateContext():ArrayCollection {
	    ...
	    var validateModel:Object={
	     ...
	     super._validator = new BankTransferQueryValidator();
	     super._validator.source = validateModel ;
	     super._validator.property = "bankTransferQuery";
		}
		...
		override public function preQuery():void {
	        ...
	        super.getSubmitQueryHttpService().url = "stl/bankTransferCancelDispatch.action?";  
    ...
    */
    private function populateRequestParams():Object {
    	...
    	reqObj.firmBankAccount = this.stlAccountNo.accountNo.text;
	    	  ...
	    	  // XenosAlert.info("I am in queryResult : "+currentState);
			   ...
			   changeCurrentState();
	    		...
	    		for(var i:int=0;i<queryResult.length;i++) {
	    			//XenosAlert.info("*** "+queryResult.getItemAt(i,0));
    ...
    override public function preResetQuery():void {
		var rndNo:Number= Math.random();
		super.getResetHttpService().url = "stl/bankTransferCancelDispatch.action?method=resetQuery&&mode=query&&menuType=Y&rnd=" + rndNo;        	
    }
    ...
    override public function preResetCancel():void {
	  var rndNo:Number= Math.random();
	  super.getResetHttpService().url = "stl/bankTransferCancelDispatch.action?&rnd=" + rndNo;  
	  var reqObject:Object = new Object();
	  reqObject.mode=this.mode;
  	...
  	private function resetValues():void {
		...
		this.stlAccountNo.accountNo.text = null;
	...
	private function getOurBankSettleAcc(item:Object, column:DataGridColumn):String {
		return item.ourBankSettleAcc;
	}
	private function getCpBankSettleAcc(item:Object, column:DataGridColumn):String {
		return item.cpBankSettleAcc;
	}
