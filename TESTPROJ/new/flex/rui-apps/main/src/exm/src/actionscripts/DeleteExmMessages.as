...
override public function preEntry():void{                               
    ...
    super.getSaveHttpService().url = "exm/ExmMessageDeleteDispatchAction.action?rnd="+rndNo; 
...
{           
    uConfSubmit.enabled = false;
    var reqObj :Object = new Object();  
    super.getConfHttpService().url = "exm/ExmMessageDeleteDispatchAction.action?rnd="+Math.random();  
