...
override public function preEntry():void{                               
    ...
    super.getSaveHttpService().url = "exm/ExmMessageDetailsDispatchAction.action?rnd="+rndNo;              
...
private function populateRequestParams():Object {
    ...
    reqObj.method = "recycleMessages";
    reqObj['SCREEN_KEY']="11131";                
...
{           
    uConfSubmit.enabled = false;
    var reqObj :Object = new Object();  
    super.getConfHttpService().url = "exm/ExmMessageDetailsDispatchAction.action?rnd="+Math.random();  
    super.getConfHttpService().method = HTTPRequestMessage.POST_METHOD;
    reqObj.method= "confirmRecycleMessages";
    reqObj['SCREEN_KEY']="11132";
