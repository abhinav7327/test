...
override public function preEntry():void{                               
    ...
    super.getSaveHttpService().url = "exm/ExmMessageTrashDispatchAction.action?rnd="+rndNo;              
...
private function populateRequestParams():Object {
    ...
    reqObj.method = "deleteMessage";
    reqObj['SCREEN_KEY']="11133";                
...
{           
    uConfSubmit.enabled = false;
    var reqObj :Object = new Object();  
    super.getConfHttpService().url = "exm/ExmMessageTrashDispatchAction.action?rnd="+Math.random();  
    super.getConfHttpService().method = HTTPRequestMessage.POST_METHOD;
    reqObj.method= "confirmDeleteMessage";
