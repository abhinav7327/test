...
private function goToSystemConfirmation():void {
	...
	var reqObj : Object = new Object();
        reqObj["SCREEN_KEY"] = 12119;
        reqObj["method"] = "submitSysConfirm";
        reqObj.rnd = Math.random();   
        //reqObj.selectedResultViewList = selectedResultViewList;
        reqObj.commandFormId = commandFormId;
        suspendedTransactionQuerySysConfRequest.request = reqObj;
        suspendedTransactionQuerySysConfRequest.send();
}
	...
	if(event.result != null){
		...
		if(commandForm != null){
			if(commandForm.selectedResultViewList != null){
				...
				this.title = this.parentApplication.xResourceManager.getKeyValue('fam.popup.suspendedtransaction.sysconf.popup.title');
