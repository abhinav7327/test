 ...
 // ActionScript file for Gle Nav Query
	...
	[Bindable]private var fromPage : String = "navSummaryview";
	[Bindable]private var resultPk : String = "";
	[Bindable]private var assetsOrLiability : String = "";
	...
	*/
		...
		try {
			...
			if(params != null) {
				for (var i:int = 0; i < params.length; i++) {
					...
					if (tempA[0] == "assetsOrLiability") {
						assetsOrLiability = tempA[1];
					}
				}
			}
			//XenosAlert.info("[" + fundCodeStr + "][" + valuationDateDisplay + "][" + fromPage + "]");
		} catch (e:Error) {
			trace(e);
		}               
	}
    ...
    private function populateRequestParams():Object {
    	...
    	reqObj.method = "viewDetail";
    	reqObj.resultPk=this.resultPk;
    	reqObj.fromPage = this.fromPage;
    	reqObj.assetsOrLiability = this.assetsOrLiability;
	...
	override public function preQueryResultHandler():Object{
        ...
        resultlist.addItem("resultView4List.resultView4");
        resultlist.addItem("previousTraversable4");
        resultlist.addItem("nextTraversable4");	    	
		return resultlist;        	
	}
