 ...
 // ActionScript file for Gle Nav Query
	...
	[Bindable]private var fromPage : String = "navResultview";
	...
	*/
	...
	override public function preQueryResultHandler():Object{
        ...
        resultlist.addItem("resultView3List.resultView3");
        resultlist.addItem("previousTraversable3");
        resultlist.addItem("nextTraversable3");
		return resultlist;        	
	}
