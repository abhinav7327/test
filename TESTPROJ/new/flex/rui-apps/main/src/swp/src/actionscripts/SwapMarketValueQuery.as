...
import com.nri.rui.swp.validator.MarketValueQueryValidator;
...
{      
    ...
    super.getInitHttpService().url = "swp/marketValueQueryDispatchAction.action?method=initialExecute&rnd=" + rndNo;
    var req : Object = new Object();
    req.SCREEN_KEY = "99992";
...
{
    var rndNo:Number= Math.random(); 
    super.getInitHttpService().url = "swp/marketValueAmendQueryDispatchAction.action?method=initialExecute&rnd=" + rndNo;
    var req : Object = new Object();
    req.SCREEN_KEY = "99993";
    super.getInitHttpService().request = req;
}
...
{
    var rndNo:Number= Math.random(); 
    super.getInitHttpService().url = "swp/marketValueCancelQueryDispatchAction.action?method=initialExecute&rnd=" + rndNo;
    var req : Object = new Object();
    req.SCREEN_KEY = "99994";
    super.getInitHttpService().request = req;
}
...
private function commonInit(mapObj:Object):void
{
    ...
    /* Base Date To population*/
    if(mapObj[keylist.getItemAt(0)]!=null){
        /*baseDateTo.text = DateUtils.toDate(mapObj[keylist.getItemAt(0)] as String);*/
	baseDateTo.text = mapObj[keylist.getItemAt(0)].toString();
    }
    ...
    /* End of populating the Status field */
...
{
    var swapMarketValueQueryModel:Object = {
                            swapMarketValueQuery:{                                 
    ...
    super._validator = new MarketValueQueryValidator();
    super._validator.source = swapMarketValueQueryModel ;
    super._validator.property = "swapMarketValueQuery";
}
...
{      
    setValidator();
    qh.resetPageNo();
    super.getSubmitQueryHttpService().url = "swp/marketValueQueryDispatchAction.action?";
...
override public function preAmend():void
{
    setValidator();
    qh.resetPageNo();
    super.getSubmitQueryHttpService().url = "swp/marketValueAmendQueryDispatchAction.action?";
    super.getSubmitQueryHttpService().request = populateRequestParams();  
}
...
override public function preCancel():void
{
    setValidator();
    qh.resetPageNo();
    super.getSubmitQueryHttpService().url = "swp/marketValueCancelQueryDispatchAction.action?";
    super.getSubmitQueryHttpService().request = populateRequestParams();       
}
...
{        
    ...
    if(this.mode == 'QUERY')
    {
     reqObj.SCREEN_KEY = "12049";
    } else if(this.mode == 'AMEND')
    {
     reqObj.SCREEN_KEY = "12051";
    }
    ...
    var notAmtFromFormatted:String = notionalAmountFrom.text;
    notAmtFromFormatted = notAmtFromFormatted.replace(myPattern , "");
    reqObj.notionalAmountFrom = notAmtFromFormatted;
    var notAmtToFormatted:String = notionalAmountTo.text;
    notAmtToFormatted = notAmtToFormatted.replace(myPattern , "");
    reqObj.notionalAmountTo = notAmtToFormatted; */   
...
{
    var rndNo:Number= Math.random();
    super.getResetHttpService().url = "swp/marketValueQueryDispatchAction.action?method=initialExecute&rnd=" + rndNo;
}
        
override public function preResetAmend():void
{
    var rndNo:Number= Math.random();
    super.getResetHttpService().url = "swp/marketValueAmendQueryDispatchAction.action?method=initialExecute&rnd=" + rndNo;            
}
        
override public function preResetCancel():void
{
    var rndNo:Number= Math.random();
    super.getResetHttpService().url = "swp/marketValueCancelQueryDispatchAction.action?method=initialExecute&rnd=" + rndNo;                
}
...
override public function preGenerateXls():String
{
    var url : String =null;
    if(mode == "QUERY"){                    
      url = "swp/marketValueQueryDispatchAction.action?method=generateXLS";
    }else if(mode == "AMEND"){
        url = "swp/marketValueAmendQueryDispatchAction.action?method=generateXLS";
    }else{
        url = "swp/marketValueCancelQueryDispatchAction.action?method=generateXLS";
    }
    return url;
}
...
override public function preGeneratePdf():String
{
    var url : String =null;
    if(mode == "QUERY"){                    
      url = "swp/marketValueQueryDispatchAction.action?method=generatePDF";
    }else if(mode == "AMEND"){
        url = "swp/marketValueAmendQueryDispatchAction.action?method=generatePDF";
    }else{
        url = "swp/marketValueCancelQueryDispatchAction.action?method=generatePDF";
    }
    return url;
}
