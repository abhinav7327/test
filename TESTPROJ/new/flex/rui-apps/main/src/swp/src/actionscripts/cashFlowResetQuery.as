...
private function commonInit(mapObj:Object):void
{
   ...
   /* End of populating the Trade Status */
   ...
   /* Populating the Delivery Receive Flag */
    ...
    tradeDeliveryReceiveFlag.dataProvider = initcol;
...
{        
    ...
    reqObj.cashflowType = this.cashflowType.text;    
	...
	*/
    reqObj.deliveryReceiveFlag = (this.tradeDeliveryReceiveFlag.selectedItem != null ? this.tradeDeliveryReceiveFlag.selectedItem.value : "");
    reqObj.notionalAmountFrom = this.notionalAmountFrom.text;
    reqObj.notionalAmountTo = this.notionalAmountTo.text;    
    reqObj.paymentCurrency = this.streamPaymentCurrency.ccyText.text;
