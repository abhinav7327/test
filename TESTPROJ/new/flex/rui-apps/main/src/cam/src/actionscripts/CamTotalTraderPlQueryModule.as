// ActionScript file
import com.nri.rui.cam.validators.CamTotalTraderPlQueryValidator;
...
import mx.utils.StringUtil;
     ...
     override public function preQueryInit():void {
        ...
        super.getInitHttpService().url = "cam/traderPlTotQueryDispatch.action?method=initialExecute&&mode=query&SCREEN_KEY=848&menuType=Y&rnd=" + rndNo;          
     }
     ...
     private function addCommonKeys():void {  
        ...
        keylist.addItem("applicationDate");
     ...
     private function commonInit(mapObj:Object):void {
        ...
        //set the base date
        baseDateItemRndr = mapObj[keylist.getItemAt(0)].toString();
     ...
     override public function preQuery():void {
        setValidator();
        qh.resetPageNo();
        super.getSubmitQueryHttpService().url = "cam/traderPlTotQueryDispatch.action?"; 
     ...
     private function setValidator():void {
        var myModel:Object = {
                                traderplquery:{
                                 ...
                                 accoutNo:(this.actPopUp.accountNo.text),
                                 securityCode:(this.instPopUp.instrumentId.text)                                
                                }
                             }; 
        super._validator = new CamTotalTraderPlQueryValidator();
        super._validator.source = myModel;
        super._validator.property = "traderplquery";
     }
     ...
     private function populateRequestParams():Object {
        ...
        reqObj.settlementCcy = this.issueccy.ccyText.text; 
     ...
     override public function postQueryResultHandler(mapObj:Object):void {
        ...
        resultHead.text = movBasisItemRndr + " " + this.parentApplication.xResourceManager.getKeyValue('cam.totalquery.traderplquery.summary.label.traderpl') + " " + baseDateItemRndr;
        commonResult(mapObj);
     }
     ...
     override public function preResetQuery():void {
        var rndNo:Number = Math.random();
        super.getResetHttpService().url = "cam/traderPlTotQueryDispatch.action?method=resetQuery&&mode=query&SCREEN_KEY=848&menuType=Y&rnd=" + rndNo;
     }
        
     override  public function preGenerateXls():String {
        var url:String = null;
        if(mode == "query") {                   
            url = "cam/traderPlTotQueryDispatch.action?method=generateXLS";
        }
        return url;
     }
     ...
     override public function preGeneratePdf():String {
        var url:String = null;
        if(mode == "query") {                   
            url = "cam/traderPlTotQueryDispatch.action?method=generatePDF";
        }
        return url;
     }  
