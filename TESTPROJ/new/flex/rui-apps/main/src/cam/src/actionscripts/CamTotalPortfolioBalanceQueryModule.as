// ActionScript file
import com.nri.rui.cam.validators.CamTotalPortfolioBalanceQueryValidator;
...
import mx.utils.StringUtil;
     ...
     override public function preQueryInit():void {
        ...
        super.getInitHttpService().url = "cam/camTotPortfolioBalanceQueryDispatch.action?method=initialExecute&SCREEN_KEY=844&mode=query&&menuType=Y&rnd=" + rndNo;           
     }
     ...
     override public function preQuery():void {
        setValidator();
        qh.resetPageNo();
        super.getSubmitQueryHttpService().url = "cam/camTotPortfolioBalanceQueryDispatch.action?";  
     ...
     private function setValidator():void {
        ...
        super._validator = new CamTotalPortfolioBalanceQueryValidator();
        super._validator.source = myModel;
        super._validator.property = "portfoliobalanceQuery";
     }
     ...
     override public function postQueryResultHandler(mapObj:Object):void {
        ...
        resultHead.text = movBasisItemRndr + " " + this.parentApplication.xResourceManager.getKeyValue('cam.portfoliobalance.summary.label.total.portfoliobalance') + " " + baseDateItemRndr;
        commonResult(mapObj);
     }
     ...
     override public function preResetQuery():void {
        var rndNo:Number = Math.random();
        super.getResetHttpService().url = "cam/camTotPortfolioBalanceQueryDispatch.action?method=resetQuery&SCREEN_KEY=844&mode=query&&menuType=Y&rnd=" + rndNo;
     }
        
     override  public function preGenerateXls():String {
        var url:String = null;
        if(mode == "query") {                   
            url = "cam/camTotPortfolioBalanceQueryDispatch.action?method=generateXLS";
        }
        return url;
     }
     ...
     override public function preGeneratePdf():String {
        var url:String = null;
        if(mode == "query") {                   
            url = "cam/camTotPortfolioBalanceQueryDispatch.action?method=generatePDF";
        }
        return url;
     }  
