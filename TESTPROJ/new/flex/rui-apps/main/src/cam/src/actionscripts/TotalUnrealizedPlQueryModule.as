// ActionScript file
import com.nri.rui.cam.validators.TotalUnrealizedPlValidator;
...
import mx.utils.StringUtil;
    ...
    public var movBasisItemRndr:String = ""; // Nedded to hold value at submit time to pass in the ItemRenderer
        ...
        override public function preQueryInit():void{
            ...
            /*  this.status.includeInLayout = true;
                ...
                super.getInitHttpService().url = "cam/unrealizedPlTotQueryDispatch.action?method=initialExecute&&mode=query&SCREEN_KEY=846&menuType=Y&rnd=" + rndNo;          
        }
        ...
        this.plDate.selectedDate = DateUtils.toDate(mapObj[keylist.getItemAt(0)].toString());
     ...
     /**
        ...
        override public function postQueryResultInit(mapObj:Object):void{
            ...
            var myModel:Object={
                            unrealizedPl:{
                                 ...
                                 plDate:this.plDate.text
                            }
                           }; 
             super._validator = new TotalUnrealizedPlValidator();
             super._validator.source = myModel;
             super._validator.property = "unrealizedPl";
             baseDateItemRndr = plDate.text;
             movBasisItemRndr = balanceType.selectedItem.value;
        ...
        override public function preQuery():void{
           ...
           // XenosAlert.info("I am in preQuery ");
            super.getSubmitQueryHttpService().url = "cam/unrealizedPlTotQueryDispatch.action?";  
   ...
   override public function preResetQuery():void{
               var rndNo:Number= Math.random();
               super.getResetHttpService().url = "cam/unrealizedPlTotQueryDispatch.action?method=resetQuery&SCREEN_KEY=846&mode=query&&menuType=Y&rnd=" + rndNo;   
   ...
   override  public function preGenerateXls():String{
             var url : String =null;
                if(mode == "query"){                    
                  url = "cam/unrealizedPlTotQueryDispatch.action?method=generateXLS";
                }
                return url;
         }  
   override public function preGeneratePdf():String{
           ...
           var url : String =null;
                if(mode == "query"){                    
                  url = "cam/unrealizedPlTotQueryDispatch.action?method=generatePDF";
                }
                return url;
          } 
