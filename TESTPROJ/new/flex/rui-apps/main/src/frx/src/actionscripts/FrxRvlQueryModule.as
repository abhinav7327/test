...
import mx.utils.StringUtil;
        ...
        override public function preGenerateXls():String {
            var url:String = null;
            if(mode == "query") {                   
              url = "frx/frxRvlQueryDispatch.action?method=generateXLS";
            } else {
                if(mode == "amend") {
                    url = "frx/frxRvlQueryDispatch.action?method=generateXLS";
                } else {
        ...
        override public function preGeneratePdf():String {
            var url:String = null;
            if(mode == "query") {                   
                url = "frx/frxRvlQueryDispatch.action?method=generatePDF";
            } else {
                if(mode == "amend") {
                    url = "frx/frxRvlQueryDispatch.action?method=generatePDF";
                } else {
        ...
        override public function preQueryInit():void {
			...
			super.getInitHttpService().url = "frx/frxRvlQueryDispatch.action?";
			var reqObject:Object = new Object();
		  	   reqObject.rnd = rndNo;
            	reqObject.method= "initialExecute";
		  		reqObject.mode="query";
		  		reqObject.menuType="Y";
		  		reqObject.SCREEN_KEY = "929";
        ...
        private function commonInit(mapObj:Object):void {
            ...
            this.cpAccountNo.accountNo.text = "";
        ...
        override public function preQuery():void {
            setValidator();
            qh.resetPageNo();
            super.getSubmitQueryHttpService().url = "frx/frxRvlQueryDispatch.action?";  
        ...
        */
        private function populateRequestParams():Object {
            ...
            reqObj.baseCcy = this.tradeccy.ccyText.text;            
            reqObj.againstCcy = this.againstccy.ccyText.text;
        ...
        override public function preResetQuery():void {
            var rndNo:Number= Math.random();
            super.getResetHttpService().url = "frx/frxRvlQueryDispatch.action?method=resetRvlQueryForm&&mode=query&&menuType=Y&rnd=" + rndNo;           
        }    