...
import com.nri.rui.cax.validator.EntitlementAmendValidator;
 ...
 */
 ...
 /**
  * To store the Rights Detail PK passed in the URL. 
  */
 [Bindable]private var rightsDetailPk : String = "";
 /**
    ...
    try {
        ...
        if(params != null){
              for (var i:int = 0; i < params.length; i++) {
                ...
                if (tempA[0] == "rightsDetailPk") {
                     this.rightsDetailPk = tempA[1];
                }     
            }
        } 
    } catch (e:Error) {
  ...
  * This method sets the URL for Amend Entry Screen for a particular Entitlement and sends the Https request to server. 
  * @override 
  * @see com.nri.rui.core.containers.XenosEntryModule.preAmendInit
  */
  override public function preAmendInit():void { 
        
    super.getInitHttpService().url = "cax/RightsAmendDetailViewDispatch.action?";
    var reqObject:Object = new Object();
    reqObject.method= "detailsViewForAmend";
    reqObject.SCREEN_KEY = 452;
    reqObject.rightsDetailPk = this.rightsDetailPk;
    super.getInitHttpService().request = reqObject;
  }
    
 /**
  * Method to add the list of keys (ids of the item) to be showed in the Amend Enrty UI.
  ...
  */
  override public function preAmend():void {
    ...
    setValidator();
    super.getSaveHttpService().url = "cax/rightsDetailsDispatch.action?";  
  ...
  */
  override public function preAmendConfirm():void {
    ...
    super.getConfHttpService().url = "cax/rightsDetailsDispatch.action?";  
    reqObj.method= "commitRightsDetailsAmend";
    reqObj.SCREEN_KEY = 454;
  ...
  override public function postConfirmAmendResultHandler(mapObj:Object):void {
    ...
    if(mapObj!=null){
        ...
        if( mapObj["errorFlag"].toString() == "error"){
            ...
            this.parentDocument.title ="Entitlement Amend - System Confirmation";
            errPage.clearError(super.getSaveResultEvent()); 
            populateData(mapObj,"CONFIRM");
  ...
  */
  override public function preResetAmend():void {
    ...
    var reqObj :Object = new Object();
    super.getResetHttpService().url = "cax/rightsDetailsDispatch.action?";  
    reqObj.method= "resetRightsDetailsAmend";
  ...
  */    
  private function doBackAmend(screenType:String):void {
    switch(screenType) {
        case "AMEND":
            this.parentDocument.dispatchEvent(new CloseEvent(CloseEvent.CLOSE));
        ...
        case "CONFIRM":
            ...
            this.parentDocument.title =this.parentApplication.xResourceManager.getKeyValue('cax.entitlement.amend');
            this.submitBtn.enabled = true;
            this.uConfLabel.visible = false;
            this.uConfLabel.includeInLayout = false;
  ...
  */
  private function populateKeyList():void {
    ...
    keylist.addItem("inConsistencyFlag"); 
  ...
  */ 
  private function populateData(mapObj:Object,screenType:String):void {
    ...
    this.rcReferenceNo.text=mapObj[keylist.getItemAt(2)].toString();
    this.accountNo.text=mapObj[keylist.getItemAt(3)].toString();
    this.subEventTypeDescription.text=mapObj[keylist.getItemAt(4)].toString();
    this.conditionStatus.text=mapObj[keylist.getItemAt(5)].toString();
    this.instrumentCode.text=mapObj[keylist.getItemAt(6)].toString();
    this.instrumentName.text=mapObj[keylist.getItemAt(7)].toString();
    this.allottedInstrument.text=mapObj[keylist.getItemAt(8)].toString();
    this.allottedInstrumentName.text=mapObj[keylist.getItemAt(9)].toString();
    this.securityBalanceStr.text=mapObj[keylist.getItemAt(12)].toString();
    this.uConfsecurityBalanceStr.text = mapObj[keylist.getItemAt(12)].toString();    
    this.uEventTypeNameConf.text = mapObj[keylist.getItemAt(27)].toString(); 
    this.paymentDate.text =  mapObj['paymentDate'].toString();
    this.uPaymentDateConf.text =  mapObj['paymentDate'].toString();      
        
    var detailType:String = mapObj[keylist.getItemAt(18)].toString();
    
    if(XenosStringUtils.equals(detailType,"NCM_RIGHTS_DETAIL")){
        this.locationAccountLbl.visible = true;
        this.locationAccountLbl.includeInLayout=true;
        this.ownershipAccountLbl.visible = false;
        this.ownershipAccountLbl.includeInLayout=false;     
    } else {
        this.locationAccountLbl.visible = false;
        this.locationAccountLbl.includeInLayout=false;
        this.ownershipAccountLbl.visible = true;
        this.ownershipAccountLbl.includeInLayout=true;  
    }
    corporateActionId = mapObj[keylist.getItemAt(11)].toString();
    stockOptionFlag = mapObj[keylist.getItemAt(28)].toString();
    ...
    switch(screenType) {
        case "AMEND":
        var editable:String = mapObj['editableAllotedSec'].toString();
        
        
        editableAllotSec(mapObj,editable,isIncome);
        
            loadCashPart(mapObj,detailType);
            loadStockPart(mapObj,detailType);               
        break;
        case "CONFIRM":         
            loadCashPartConfirm(mapObj,detailType);
            loadStockPartConfirm(mapObj,detailType);
        break;
    }   
  ...
  private function editableAllotSec(mapObj:Object,editable:String,isIncome:String):void{
  	if(editable == 'Y'){
  		...
  		this.allottedInstrumentNameTxt.visible = true;
  		this.allottedInstrumentNameTxt.includeInLayout = true;
  		this.allottedInstrumentNameTxt.text = mapObj[keylist.getItemAt(9)].toString();
  		if(isIncome == 'true'){
  			isIncomeFlag = true;
  			this.allotCcy.visible = true;
  			this.allotCcy.includeInLayout = true;
  			this.allotSecurityCode.visible = false;
  			this.allotSecurityCode.includeInLayout = false;
  			this.allotCcy.ccyText.text = mapObj[keylist.getItemAt(8)].toString();
  			...
  			this.allotSecurityCode.visible = true;
  			this.allotSecurityCode.includeInLayout = true;
  			this.allotSecurityCode.instrumentId.text = mapObj[keylist.getItemAt(8)].toString();
  		}
  	}else{
  		this.allottedInstrument.visible = true;
  		this.allottedInstrument.includeInLayout = true;
  ...
  */ 
  private function loadTaxDetail(mapObj:Object):void {
    ...
    for each(item in (mapObj[keylist.getItemAt(19)] as ArrayCollection)){
        item.isVisible = true;
    ...
    //editIndexTaxFeeNo
    this.editIndexTaxFeeNo = mapObj[keylist.getItemAt(23)];
  ...
  */ 
  private function loadCashPart(mapObj:Object, detailType:String):void {
    ...
    /** Populating giveUp : for NCM_RIGHTS_DETAIL its should be visible
     *  For RIGHTS_DETAIL - should be hidden.
     */ 
    if(XenosStringUtils.equals(detailType,"RIGHTS_DETAIL")){
        ...
        for each(item in (mapObj[keylist.getItemAt(10)] as ArrayCollection)){
            ...
            if(item.value == mapObj[keylist.getItemAt(17)].toString())
                index = (mapObj[keylist.getItemAt(10)] as ArrayCollection).getItemIndex(item);            
        }
        this.cashPart.giveUp.dataProvider = initcol;    
        this.cashPart.giveUp.selectedIndex = index; 
    } else {
        this.cashPart.giveUp.visible = false;
        this.cashPart.giveUpGridLabel.visible = false;
    }
    ...
    this.cashPart.allottedAmountStr.text=mapObj[keylist.getItemAt(13)].toString();
    this.cashPart.splAmountOrQtyStr.text = mapObj[keylist.getItemAt(14)].toString();
    this.cashPart.remarks.text = mapObj[keylist.getItemAt(24)].toString();
    this.cashPart.availableDate.text=mapObj['availableDate'].toString();
    this.cashPart.inconsistencyflag.text=mapObj['inConsistencyFlagDisp'].toString();
    ...
    for each(var item:Object in mapObj['finalizedFlagDropdownList.item']){
    	if(item.value==mapObj['finalizedFlag'].toString()){
    		this.cashPart.finalizedflag.selectedIndex=indx;
    		break;
    	}
    	indx++;
  ...
  * @param detailType - Detail Type RIGHTS_DETAIL' or 'NCM_RIGHTS_DETAIL'
  */
  private function loadCashPartConfirm(mapObj:Object, detailType:String):void {
    ...
    this.cashPart.netAmntRow.visible = true;
    this.cashPart.netAmntRow.includeInLayout = true;
    ...
    if(XenosStringUtils.equals(detailType,"RIGHTS_DETAIL")){
        ...
        this.cashPart.uConfgiveUp.visible = false;
        this.cashPart.uConfgiveUpGridLabel.visible = false;
    }
    ...
    this.cashPart.uConfallottedAmountStr.text=mapObj[keylist.getItemAt(13)].toString();
    this.cashPart.uConfsplAmountOrQtyStr.text = mapObj[keylist.getItemAt(14)].toString();
    this.cashPart.uConfremarks.text = mapObj[keylist.getItemAt(24)].toString();
    this.cashPart.availableDateConf.text=mapObj['availableDate'].toString();
    
    this.cashPart.inconsistencyflagConf.text=mapObj['inConsistencyFlagDisp'].toString();
    this.cashPart.finalizeflagConf.text=mapObj['finalizedFlagDisp'].toString();
    this.cashPart.uNetamount.text=mapObj['netAmountStr'].toString();
  ...
  * @param detailType - Detail Type RIGHTS_DETAIL' or 'NCM_RIGHTS_DETAIL'* 
  */ 
  private function loadStockPart(mapObj:Object, detailType:String):void {
    ...
    this.stockPart.availableDate.text=mapObj['availableDate'].toString();
    this.stockPart.allottedAmountStr.text=mapObj[keylist.getItemAt(13)].toString();
    this.stockPart.allottedQuantityStr.text=mapObj[keylist.getItemAt(20)].toString();
    this.stockPart.splAmountOrQtyStr.text = mapObj[keylist.getItemAt(14)].toString();
    this.stockPart.remarks.text = mapObj[keylist.getItemAt(24)].toString();
    this.stockPart.fractionalShareStr.text = mapObj[keylist.getItemAt(21)].toString();
    ...
    if(!XenosStringUtils.equals(corporateActionId,"NAME_CHANGE")){
            ...
            this.stockPart.cashInLieuFlagExp.text=mapObj[keylist.getItemAt(22)].toString();
    } else {
        this.stockPart.cashInLieuLabel.visible = false;
    }
    
    var hiddenCashInLieuFlag :String = mapObj[keylist.getItemAt(25)].toString();
    ...
    this.stockPart.inconsistencyflag.text=mapObj['inConsistencyFlagDisp'].toString();
  ...
  * @param detailType - Detail Type RIGHTS_DETAIL' or 'NCM_RIGHTS_DETAIL'* 
  */ 
  private function loadStockPartConfirm(mapObj:Object, detailType:String):void {
    ...
    this.stockPart.uConfallottedAmountStr.text=mapObj[keylist.getItemAt(13)].toString();
    this.stockPart.uConfallottedQuantityStr.text=mapObj[keylist.getItemAt(20)].toString();
    this.stockPart.uConfsplAmountOrQtyStr.text = mapObj[keylist.getItemAt(14)].toString();
    this.stockPart.uConfremarks.text = mapObj[keylist.getItemAt(24)].toString();
    this.stockPart.uConffractionalShareStr.text = mapObj[keylist.getItemAt(21)].toString();
    this.stockPart.availableDateConf.text=mapObj['availableDate'].toString();
    ...
    if(!XenosStringUtils.equals(corporateActionId,"NAME_CHANGE")){
            ...
            this.stockPart.uConfcashInLieuFlagExp.text=mapObj[keylist.getItemAt(22)].toString();
    } else {
    ...
    this.stockPart.inconsistencyflagConf.text=mapObj['inConsistencyFlagDisp'].toString();
  ...
  */
  private function preAddTaxFeeHandler(methodFlag:String):void {
    ...
    if(validateTaxFee(methodFlag)) {
        taxFeeInformation.url = "cax/rightsDetailsDispatch.action?";
        var reqObject:Object = new Object();
  ...
  */
  public function preEditFeeDetailHandler(data:Object):void {
        ...
        editFeeDetail.url = "cax/rightsDetailsDispatch.action?";
        var reqObject:Object = new Object();
  ...
  */
  public function preDeleteFeeDetailHandler(data:Object):void {
    ...
    deleteFeeDetail.url = "cax/rightsDetailsDispatch.action?";
    var reqObject:Object = new Object();
    reqObject.editIndexTaxFeeNo = this.detailTaxFeeList.getItemIndex(data);
  ...
  */
  public function preCalculateHandler():void {
    ...
    securityBalance.url = "cax/rightsDetailsDispatch.action?";
    var reqObject:Object = new Object();
  ...
  */
  public function preTaxAmountCalculateHandler():void {
    ...
    taxAmount.url = "cax/rightsDetailsDispatch.action?";
    var reqObject:Object = new Object();
    reqObject.rate = this.rate.text;
    reqObject.rateType = this.rateType.text;
    reqObject.taxFeeId = this.taxFeeId.text;
  ...
  */
  private function populateRequestParams():Object { 
    ...
    var reqObj : Object=new Object;
    reqObj.method= "submitRightsDetailsAmend";
    ...
    switch(this.corporateActionId) {
        ...
        case "RIGHTS_EXPIRY":
            ...
            reqObj.finalizedFlag=(this.stockPart.finalizedflag.selectedItem!=null)?this.stockPart.finalizedflag.selectedItem.value:"";      
        break;
        case "OPTIONAL_STOCK_DIV":
        case "DIV_REINVESTMENT":
       		 if(XenosStringUtils.equals(stockOptionFlag,"true")) {
  ...
  */
  private function validateTaxFee(methodFlag : String): Boolean {  
    ...
    var validator:EntitlementAmendValidator = new EntitlementAmendValidator();
  ...
  */ 
  private function setValidator() : void {
    ...
    var amendValidateModel : Object = {amendValidate:{securityBalanceStr:this.securityBalanceStr.text,
    												  paymentDateStr:this.paymentDate.text}};
    super._validator = new EntitlementAmendValidator();
    super._validator.source=amendValidateModel;
    super._validator.property="amendValidate";
