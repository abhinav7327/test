...
package com.nri.rui.ref.renderers
{
	...
	public class BatchExecutionQueryDetailsRenderer extends Text
	{
		public function BatchExecutionQueryDetailsRenderer()
		{
			super();
		}
		...
		public function handleMouseClick(event:MouseEvent):void {
			...
			sPopup.title = this.parentApplication.xResourceManager.getKeyValue('ref.batchExecutionQueryDetails.label.page')
			sPopup.width = 850;
			sPopup.height = 425;
			PopUpManager.centerPopUp(sPopup);			
			sPopup.moduleUrl = Globals.BATCH_EXECUTION_QUERY_DETAILS_SWF + Globals.QS_SIGN + "pk" + Globals.EQUALS_SIGN + data.batchExecutionStatusPk;
