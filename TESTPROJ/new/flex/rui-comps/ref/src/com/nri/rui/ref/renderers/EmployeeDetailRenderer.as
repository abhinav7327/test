package com.nri.rui.ref.renderers
{
	...
	public class EmployeeDetailRenderer extends Text
	{
		public function EmployeeDetailRenderer()
		{
			super();
		}
		...
		public function handleMouseClick(event:MouseEvent):void {
			...
			var employeePk :String = data.employeePk;
			var parentApp :UIComponent = UIComponent(this.parentApplication);
			
			XenosPopupUtils.showEmployeeDetails(employeePk,parentApp);
		}
