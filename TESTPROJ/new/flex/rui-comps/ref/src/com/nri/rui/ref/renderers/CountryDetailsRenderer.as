...
package com.nri.rui.ref.renderers
{
	...
	public class CountryDetailsRenderer extends Text
	{
		public function CountryDetailsRenderer()
		{
			super();			
		}
		...
		public function handleMouseClick(event:MouseEvent):void {
			...
			var countryPk : String = data.countryPk;
			...
			sPopup.title = this.parentApplication.xResourceManager.getKeyValue('ref.country.title.renderer');
			sPopup.width = 800;
			sPopup.height = 400;
			PopUpManager.centerPopUp(sPopup);			
			sPopup.moduleUrl = Globals.COUNTRY_DETAILS_SWF+"?countryPk="+countryPk;
