...
package com.nri.rui.gle.validators
{
     ...
     * 
     */ 
    public class GleBalanceValidator extends Validator
    {
        // Define Array for the return value of doValidation().
        private var results:Array;
        
        public function GleBalanceValidator()
        {            
            super();
        }
        /**
        ...
        protected override function doValidation(value:Object):Array
        {
            ...
            /* This validation is not required as it is not a mandatory field           
            if (XenosStringUtils.isBlank(ledgerCodeTo))
            {
                results.push(new ValidationResult(true, 
                    "", "ledgerCodeTo", "Ledger Code To."));
            }*/
