...
{	
	...
	public class UnrealizedPlQueryValidator extends Validator
	{
		public var results:Array=[];
		
		public function UnrealizedPlQueryValidator()
		{			
			super();
		}
		...
		protected override function doValidation(queryModel:Object):Array
		{
            ...
            var baseDateFrom:String =  queryModel.baseDateFrom;
            var baseDateTo:String =  queryModel.baseDateTo;
            ...
            if(baseDateFrom != ""){
                ...
                var objBaseDateFrom:Date = dateformat.toDate(CustomDateFormatter.customizedInputDateString(baseDateFrom));
            }
            if(baseDateTo != ""){
                dateList.push(baseDateTo);
                var objBaseDateTo:Date = dateformat.toDate(CustomDateFormatter.customizedInputDateString(baseDateTo));
            }
            if(tradeDateFrom != "")
