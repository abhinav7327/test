...
{	        
	...
	public class RemarksEntryRenderer extends Image
	{
		...
		public function handleMouseClick(event:MouseEvent):void {
			...
			sPopup.title = "Exm Remarks Entry";
			...
			sPopup.moduleUrl = "assets/appl/exm/RemarksEntry.swf"+Globals.QS_SIGN+"messagePk"+Globals.EQUALS_SIGN+messagePkStr+Globals.AND_SIGN+"mode"+Globals.EQUALS_SIGN+"edit";
