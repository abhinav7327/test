...
package com.nri.rui.stl.renderers
{
	...
	public class CashTransferAdjustmentQueryDetailRenderer extends Text
	{
		public function CashTransferAdjustmentQueryDetailRenderer()
		{
			super();
		}
		...
		public function handleMouseClick(event:MouseEvent):void {
			...
			sPopup.title = Application.application.xResourceManager.getKeyValue('stl.adjustment.query.header');
			sPopup.width = 780;
			sPopup.height = 400;
			PopUpManager.centerPopUp(sPopup);		
			var cashEntryPk : String = data.cashEntryPk;
			//sPopup.moduleUrl = NcmConstants.ADJUSTMENET_QRY_DETAILS_SWF+Globals.QS_SIGN+NcmConstants.NCM_ENTRY_PK+Globals.EQUALS_SIGN+cashEntryPk;
