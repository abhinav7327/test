...
package com.nri.rui.stl.renderers
{
	...
	public class SettlementHistoryDetailRenderer extends Text
	{
		public function SettlementHistoryDetailRenderer()
		{
			super();
		...
		override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void {
			 super.updateDisplayList(unscaledWidth, unscaledHeight);
				/* if(listData){
					...
					var settlementHistoryRefNo:String = data.refNo;
					text = settlementHistoryRefNo;
				}
		...
		private function setVisibleProp():void{
		 ...
		 public function handleMouseClick(event:MouseEvent):void {
			...
			var stlHistoryPkStr : String = data.detailHistoryPk;
			var parentApp :UIComponent = UIComponent(this.parentApplication);
			XenosPopupUtils.showSettlementHistoryDetails(stlHistoryPkStr,
														 parentApp,
														 this.parentApplication.xResourceManager.getKeyValue('stl.stlqry.label.settlement.history.details'));
