...
package com.nri.rui.fam.validators
{
     ...
     * 
     */    
    public class FamTrashSuspendedTxnQueryValidator extends Validator
    {
        ...
        // constructor
        public function FamTrashSuspendedTxnQueryValidator()
        {
            super();
        }
		...
		/**
		 *
		 * validate trash suspended transaction query form
		 */
