...
package com.nri.rui.core.renderers
{
	...
	public class AdvFinancialInstitutionDetailsRenderer extends Text
	{
		public function AdvFinancialInstitutionDetailsRenderer()
		{
			super();
		}
		...
		public function handleMouseClick(event:MouseEvent):void {
			...
			var bankPkStr : String ;
			if(listData){
					var dg : DataGrid = DataGrid(listData.owner);
					var column : DataGridColumn = dg.columns[listData.columnIndex];
					bankPkStr = data[column.dataField];
					
			}
			
			var parentApp :UIComponent = UIComponent(this.parentApplication);
			XenosPopupUtils.showFinInstDetails(bankPkStr,parentApp);
		}
