...
package com.nri.rui.core.renderers
{
	...
	public class NewmCancRenderer extends Label {
		
		private const CXL_COLOR:uint = 0xFF0000; // Red
		
		public function NewmCancRenderer() {
			super();
		}
		...
		{				
			...
			if(listData){
               	...
               	}else if(XenosStringUtils.equals(text,Globals.STATUS_CANCEL) || XenosStringUtils.equals(text,"CANC")){
                    text = "CANC";
            	}
   			}
   		}
        ...
        override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void {
            ...
            if(XenosStringUtils.equals(text,Globals.STATUS_CANCEL) || XenosStringUtils.equals(text,"CANC")){
