...
package com.nri.rui.core.renderers
{
	...
	public class FundAccountDetailRenderer extends Text
	{
		
		public function FundAccountDetailRenderer()
		{
			super();
		...
		public function handleMouseClick(event:MouseEvent):void {
			...
			var accPkStr : String = data.fundAccountPk;
			var prefix : String = data.fundAccountPrefix;
			var parentApp :UIComponent = UIComponent(this.parentApplication);
			XenosPopupUtils.showAccountSummary(accPkStr,parentApp,prefix);
		}
