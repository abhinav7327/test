...
package com.nri.rui.smr.renderers
{
	...
	public class BloombergDetailsRenderer extends Text
	{
		public function BloombergDetailsRenderer()
		{
			super();
...
//			XenosPopupUtils.showInstrumentDetails(instPkStr,parentApp);
			var bbUniqueId : String = data.bbUniqueId;
			var exchangeMrkt : String = data.exchangeMrkt;
			var parentApp :UIComponent = UIComponent(this.parentApplication);
//			XenosPopupUtils.showInstrumentDetails(bbUniqueId,parentApp);
			//XenosPopupUtils.showBloombergDetails(bbUniqueId,parentApp);
			XenosPopupUtils.showBloombergDetails(bbUniqueId, exchangeMrkt, parentApp);
