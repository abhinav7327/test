...
package com.nri.rui.cam.validators
{
    ...
    /**
     * Custom Validator for Cam Total Query - Balance Query Implementation.
     * 
     */    
    public class CamTotalBalanceQueryValidator extends Validator
    {
    	// Define Array for the return value of doValidation().
        private var results:Array;

        // Constructor
 	public function CamTotalBalanceQueryValidator() {
            super();
        }
