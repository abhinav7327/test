...
package com.nri.rui.cam.renderers
{
	...
	public class CamSecurityDetailRenderer extends Text
	{
		
		public function CamSecurityDetailRenderer()
		{
			super();
		...
		public function handleMouseClick(event:MouseEvent):void {
			...
			var camEntryPkStr : String = data.camEntryPk;
			var parentApp :UIComponent = UIComponent(this.parentApplication);
			XenosPopupUtils.showCamSecurityDetails(camEntryPkStr,parentApp);
		}
