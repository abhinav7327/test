package com.nri.rui.cam.renderers
{
	...
	public class CamTransactionDetailRenderer extends Text
	{
		public function CamTransactionDetailRenderer()
		{
			super();
		...
		public function handleMouseClick(event:MouseEvent):void {
			...
			var triTransactionPk :String = data.triggeringTxnPk;
			...
			var viewMode:String ="Instruction"
			    XenosPopupUtils.showSettlementDetails(triTransactionPk,
			    									  parentApp,
			    									  this.parentApplication.xResourceManager.getKeyValue('cam.label.settlement.detail.header'),
			    									  viewMode);
			}else if(module == "NCM"){
			 ...
			 XenosPopupUtils.showTrdTradeDetails(triTransactionPk,parentApp);
				...
				XenosAlert.info("No Detail Screen Available for DRV");
			}else if(module =="FRX"){
				XenosAlert.info("No Detail Screen Available for FRX");
			}else if(module =="BKG"){
				XenosAlert.info("No Detail Screen Available for BKG");
			}
