package com.nri.rui.nam.validators
{
	...
	public class SbaBondFeedExecutionValidator extends Validator
	{
		// Define Array for the return value of doValidation().
		private var results:Array;

		public function SbaBondFeedExecutionValidator()
		{
			super();
		}
		...
		*/
		protected override function doValidation(value:Object):Array
		{
			...
			if (XenosStringUtils.isBlank(value.issueCurrency))
			{
				results.push(new ValidationResult(true, "issueCcy", "issueCcySbaMissing", Application.application.xResourceManager.getKeyValue('nam.sbaFeedExecution.alert.validator.issueCcySbaMissing')));
			}
