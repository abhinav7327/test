...
package com.nri.rui.rec.validators
{
     ...
     * 
     */    
    public class CashReReconValidator extends Validator
    {
        // Define Array for the return value of doValidation().
        private var results:Array;

        // constructor
        public function CashReReconValidator()
        {
            super();
        }
	    ...
	    var fundCode:String =value.fundCode;
            ...
            var secId:String =value.securityCode;
            var flag:int=0;
	     ...
	     // Check toDate and fromDate  field.           
            if (XenosStringUtils.isBlank(fundCode) && XenosStringUtils.isBlank(accNo)) {
                results.push(new ValidationResult(true, 
                    "", "notoandfromDate", "Please enter Either Fund Code or Account No."));
                return results;
            }
            //
            if (XenosStringUtils.isBlank(secId)) {
                results.push(new ValidationResult(true, 
                    "", "noSecurityId", "Please enter CCY."));
                return results;
            }
