...
{	        
	...
	public class SecurityImgSwiftRenderer extends Image
	{
		...
		private var icoSummary:Class;
		 ...
		 public function SecurityImgSwiftRenderer() {            
            super();            
			source=icoSummary;
    	 ...
    	 */ 
         public function handleMouseClick(event:MouseEvent):void { 
			...
			sPopup.title = "Security Raw File Viewer";
			sPopup.width = parentApplication.width - 100;
    		sPopup.height = parentApplication.height - 100;
			PopUpManager.centerPopUp(sPopup);
			sPopup.moduleUrl = "assets/appl/rec/SecurityRawFileView.swf"+Globals.QS_SIGN+"RowNum"+Globals.EQUALS_SIGN+listData.rowIndex.toString();
