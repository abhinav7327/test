...
package com.nri.rui.cax.renderers
{
	...
	public class RightsDetailViewRenderer extends Text
	{
		public function RightsDetailViewRenderer()
		{
			super();
		...
		public function handleMouseClick(event:MouseEvent):void {
			...
			var stlRefNo : String = data.settlementReferenceNo;
			var slrRefNo : String = data.slrActionReferenceNo;
			
			var parentApp :UIComponent = UIComponent(this.parentApplication);
			
			XenosPopupUtils.showCaxRightsDetails(rdPk,parentApp,stlRefNo,slrRefNo);
		}
