...
package com.nri.rui.cax.validator
{
	...
	public class ResetFinalizedFlagValidator extends Validator
	{
		// Define Array for the return value of doValidation().
        private var results : Array;
        
		public function ResetFinalizedFlagValidator()
		{
			super();
		}
        ...
        protected override function doValidation(value : Object) : Array
        {
            ...
            for(var iterator:int=0; iterator<dateList.length; iterator+=2){
	            ...
	            if(StringUtil.trim(dateList[iterator]) != "" && StringUtil.trim(dateList[iterator+1]) != ""){
	                ...
	                results.push(new ValidationResult(true, 
	                     "", "fromDateLessThantoDate", Application.application.xResourceManager.getKeyValue('cax.reset.finalized.flag.fromdate.greaterthan.todate')));
	            }
	            }
