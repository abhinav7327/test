 ...
 /**
 * AdjustmentValidator - Validator for Entitlement Amend UI.
 * @version 
 */ 
package com.nri.rui.cax.validator
{
	...
	public class AdjustmentValidator extends Validator {
       ...
       /**
       	*  Default Constructor
       	*/
		public function AdjustmentValidator() {
			super();
		}
        ...
        protected override function doValidation(value:Object):Array {      	
           ...
           if (value.hasOwnProperty("accountNo") && XenosStringUtils.isBlank(value.accountNo))      
            		results.push(new ValidationResult(true, 
                       "accountNo", "accountNoMissing", Application.application.xResourceManager.getKeyValue('cax.validate.accountno.blank')));
