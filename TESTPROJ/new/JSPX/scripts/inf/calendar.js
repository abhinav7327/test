...
//         <IMG SRC="common/calendar.gif" BORDER=0></A><font size=1>Popup Calendar</font>
//
//
// 
// Required Files:
...
//Change the regionStr here to keep in sync with the REF_ENTERPRISE Entry_date_format 
// and display_date_format
// For Japanese Enterprise settings use "dateValidJap.js"
// For US       Enterprise settings use "dateValidUS.js"
// For European Enterprise settings use "dateValidEuro.js"

regionStr  = "JAPAN";

 
if (regionStr == "USA")
 { document.write('<script src="../scripts/inf/dateValidUS.js"></script>');
  calDateFormat = "DD-MON-yyyy";
 }
else if (regionStr == "EUROPE")
 { document.write('<script src="../scripts/inf/dateValidEuro.js"></script>');
  calDateFormat = "DD-MON-yyyy";
 }
else if (regionStr == "JAPAN")
 { document.write('<script src="../scripts/inf/dateValidJap.js"></script>');
  calDateFormat = "yyyyMMDD";
 }

// CALENDAR COLORS
topBackground    = "#6B8EB5";         // BG COLOR OF THE TOP FRAME
bottomBackground = "#DDDDDD";         // BG COLOR OF THE BOTTOM FRAME
...
headingCellColor = "#CCCCCC";         // TABLE CELL BG COLOR OF THE WEEKDAY ABBREVIATIONS
headingTextColor = "#000000";         // TEXT COLOR OF THE WEEKDAY ABBREVIATIONS
dateColor        = "#003063";          // TEXT COLOR OF THE LISTED DATES (1-28+)

focusColor       = "#003063";       // TEXT COLOR OF THE SELECTED DATE (OR CURRENT DATE)
hoverColor       = "#CC6600";       // TEXT COLOR OF A LINK WHEN YOU HOVER OVER IT
fontStyle        = "11px verdana";      // TEXT STYLE FOR DATES
headingFontStyle = "11px verdana";      // TEXT STYLE FOR WEEKDAY ABBREVIATIONS
...
function buildTopCalFrame() {
    ...
    var calDoc =
        ...
        "<HEAD>" +
        "</HEAD>" +
        "<BODY leftmargin=1 topmargin=1 marginwidth=1 marginheight=1 BGCOLOR='" + topBackground + "'>" +
        "<FORM NAME='calControl' onSubmit='return false;'>" +
        "<CENTER>" +
        "<TABLE CELLPADDING=0 CELLSPACING=1 BORDER=0>" +
        "<TR><TD HEIGHT=35 COLSPAN=7>" +
        "<CENTER>" +
        getMonthSelect() +
...
function buildBottomCalFrame() {       
	...
	var paddingChar = "&nbsp;";
        ...
        // ADD THE DAY TO THE CALENDAR STRING
     	   calDoc += "<TD height=19 align=center bgcolor='" + cellColor + "'>" +
        ...
        // STYLESHEET DEFINES APPEARANCE OF CALENDAR
         ...
         ".focusDay { color: " + focusColor + "; text-decoration: none; font: " + fontStyle + "; }" +
  	     ".weekday { color: " + dateColor + "; text-decoration: none; font: " + fontStyle + "; }" +
   	     "A:hover { color: " + hoverColor + "; text-decoration: none; font: " + fontStyle + "; }" +
         "-->" +
        "</STYLE>" +
...
/****************************************************************************
 The methods below are written by the XENOS application developers. These
 methods are date specific methods.
 ****************************************************************************/

function checkdate(objName)
{
 	return dateValidation(objName.value);
	//return true;
}
