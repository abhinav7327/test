...
a[c.wh]=a.Spread)}},O=function(a,b){var c=a.Elem,d=c.length;z(a,2);if(a.OnDock&&!a.Stamp){for(M(a,b);d&&c[d-1].Major===c[d-1].Final;)--d;d?(N(a),a[v[2]]=C(function(){O(a,b)},a.Opts.step)):D(a,1)}},aa=function(a,b){var c=a.Elem;if(c==null){return;};var d=c.length;if(!a.OnDock){for(;d&&c[d-1].Major<=c[d-1].Initial;)--d;W(a);if(d)N(a),a[v[4]]=C(function(){aa(a,b)},a.Opts.step);else{a.Stamp=0;for(d=c.length;d--;)c[d].Major=c[d].Final=c[d].Initial;a.Current=-1;b||H(a)}}},ba=function(a,b){var c=a.Elem;if(c==null){return;};var d=c.length;if(a.OnDock){for(M(a,
